...
import { Cpu, CheckCircle2, ArrowRight, Zap, Shield, Activity, Gauge } from "lucide-react";

export function PPC() {
  const features = ["Active power regulation", "Reactive power control", "IEC 61850 certified", "Grid frequency support", "<100ms response time", "Voltage regulation", "Ramp rate control", "Automated curtailment"];
  const specs = [{ label: "Certification", value: "IEC 61850" }, { label: "Response Time", value: "<100ms" }, { label: "Accuracy", value: "±1% of rated" }, { label: "Control", value: "Remote/Local" }];
    ...
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-[20px] text-white/70 leading-relaxed mb-10">
              Grid-compliant plant controller for active power regulation and reactive power control. IEC 61850 certified with sub-100ms response time.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-[36px] font-bold text-[#1A1A1A] mb-12 text-center">Control Capabilities</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-[36px] font-bold text-[#1A1A1A] mb-6">Grid-Compliant Control</h2>
          <p className="text-[18px] text-[#4A4A4A] mb-8">Deploy certified power plant controllers.</p>
